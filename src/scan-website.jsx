        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            {/* <button
              disabled={loading}
              onClick={checkUrl}
              className="cursor-pointer w-full sm:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2"
            >
              {loading ? (
